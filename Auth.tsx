...
import { Sparkles, ArrowRight, Github, Chrome, Mail, Lock, User as UserIcon, Loader2 } from 'lucide-react';
       ...
       <div className="hidden lg:block relative overflow-hidden marble-bg p-20 flex flex-col justify-between text-brand-cream">
          ...
          <div className="space-y-8 relative z-10">
             <div className="p-8 bg-brand-cream/5 rounded-[40px] border border-brand-cream/10 backdrop-blur-sm">
                <blockquote className="serif italic text-xl opacity-80 mb-4 font-light">"Purest ingredients I've ever experienced in Nairobi. My skin has never looked more radiant."</blockquote>
          ...
          >
             ...
             <div className="space-y-8">
                <div className="relative flex items-center">
                   <div className="flex-grow border-t border-brand-forest/10"></div>
                   <span className="flex-shrink mx-4 text-[10px] font-bold uppercase tracking-widest text-brand-forest/30">Or Connect Via</span>
                   <div className="flex-grow border-t border-brand-forest/10"></div>
                </div>

                <div className="grid grid-cols-2 gap-4">
                   <button className="flex items-center justify-center space-x-3 p-4 bg-white border border-brand-forest/10 rounded-2xl hover:bg-brand-cream transition-colors">
                      <Chrome size={18} />

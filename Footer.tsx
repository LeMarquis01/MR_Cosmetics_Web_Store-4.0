      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-brand-cream/60 text-sm leading-relaxed">
              Crafting artisanal beauty and wellness solutions inspired by the lush forests and rich botanicals. Your journey to natural radiance begins here.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="p-2 border border-brand-cream/10 rounded-full hover:bg-brand-gold hover:text-brand-forest transition-colors"><Instagram size={18} /></a>
              <a href="#" className="p-2 border border-brand-cream/10 rounded-full hover:bg-brand-gold hover:text-brand-forest transition-colors"><Facebook size={18} /></a>
              <a href="#" className="p-2 border border-brand-cream/10 rounded-full hover:bg-brand-gold hover:text-brand-forest transition-colors"><Twitter size={18} /></a>
            </div>
          </div>
          ...
          {/* Contact */}
          <div className="space-y-6">
            <h4 className="text-brand-gold uppercase text-xs font-bold tracking-widest mb-6">Visit Our Studio</h4>
            <ul className="space-y-4 text-sm">
              <li className="flex items-start space-x-3">
                <MapPin size={18} className="text-brand-gold shrink-0" />
                <span className="text-brand-cream/80">Kilimani Road, Silk Tower 4th Floor,<br />Nairobi, Kenya</span>
              </li>
              <li className="flex items-center space-x-3">
                <Phone size={18} className="text-brand-gold shrink-0" />
                <span className="text-brand-cream/80">+254 700 000 000</span>
              </li>
              <li className="flex items-center space-x-3">
                <Mail size={18} className="text-brand-gold shrink-0" />
                <span className="text-brand-cream/80">studio@mrcosmetics.co.ke</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-top border-brand-cream/10 flex flex-col md:flex-row justify-between items-center text-[10px] uppercase tracking-widest text-brand-cream/40">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <span>Verified M-Pesa Partner</span>

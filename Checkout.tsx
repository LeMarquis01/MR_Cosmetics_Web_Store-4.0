                  ...
                  >
                     ...
                     <div className="grid grid-cols-2 gap-6">
                        ...
                        <div className="md:col-span-1 space-y-2">
                           ...
                           <input type="text" className="w-full bg-brand-cream border border-brand-forest/10 rounded-2xl p-4 text-sm" defaultValue="Nairobi" />
                        </div>
                        <div className="md:col-span-1 space-y-2">
                           <label className="text-[10px] font-bold uppercase tracking-widest text-brand-gold">Phone Number</label>
                           <input type="tel" className="w-full bg-brand-cream border border-brand-forest/10 rounded-2xl p-4 text-sm" placeholder="+254..." />
                        </div>
                     </div>
                ...
                {step === 2 && (
                  ...
                  >
                        ...
                        {paymentMethod === 'mpesa' && (
                          <div className="space-y-4">
                             ...
                             <div className="flex items-center space-x-4 bg-white p-4 rounded-2xl border border-brand-forest/10">
                                <span className="text-sm font-bold text-brand-forest">+254</span>
                     ...
                     <button 
                        ...
                        className="w-full h-16 bg-brand-forest text-brand-cream rounded-full font-bold uppercase tracking-widest text-xs shadow-2xl flex items-center justify-center space-x-3 disabled:opacity-50"
                     >
